...
const validateChart = () => {
  return [
    ...
    body('chart.configuration.sort').trim().blacklist('<>&\'"/'),
    body('chart.configuration.graphChart.config.*').trim().blacklist('<>&\'"/'),
    body('chart.configuration.graphChart.nodes.*.id').trim().blacklist('<>&\'"/'),
    body('chart.configuration.graphChart.nodes.*.uuid').optional({ checkFalsy: true }).isUUID(4),
    body('chart.configuration.graphChart.nodes.*.value.title').trim().blacklist('<>&\'"/'),
    body('chart.configuration.graphChart.nodes.*.value.items.*.text').trim().blacklist('<>&\'"/'),
    body('chart.configuration.graphChart.nodes.*.value.items.*.value').trim().blacklist('<>&\'"/'),
    body('chart.configuration.graphChart.nodes.*.value.items.*.icon').trim().blacklist('<>&\'"/'),
    body('chart.configuration.graphChart.edges.*.uuid').optional({ checkFalsy: true }).isUUID(4),
    body('chart.configuration.graphChart.edges.*.source').trim().blacklist('<>&\'"/'),
    body('chart.configuration.graphChart.edges.*.target').trim().blacklist('<>&\'"/'),
    body('chart.configuration.graphChart.edges.*.value').trim().blacklist('<>&\'"/'),
